...
const USATComputerScience = () => {
  ...
  const studyResourcesData = [{
    name: "USAT CS Prep Course",
    type: "YouTube",
    link: "#"
  }, {
    name: "Computer Science USAT Guide",
    type: "Website",
    link: "#"
  }, {
        ...
        <div className="mobile-container pt-8">
          ...
          duration: 0.6
            ...
            <div className="relative w-full h-48 rounded-2xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800&h=400&fit=crop" alt="Computer Science USAT" className="w-full h-full object-cover" />
            </div>

            {/* Header */}
            <div className="space-y-4">
              <h1 className="font-secondary font-bold text-2xl text-brand-orange">USAT Computer Science</h1>
              <p className="font-primary text-muted-foreground text-sm">
                Undergraduate Studies Aptitude Test for Computer Science, is the basic requirement for applying this scholarship.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-brand-light-green rounded-lg p-3">
                    <div className="flex justify-between">
                      <span className="font-primary font-medium">Computer Science</span>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Focus on programming fundamentals, data structures, and algorithms.
                  </p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-brand-orange rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-sm text-muted-foreground">
                    Review mathematical concepts including discrete mathematics and statistics.
                  </p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-brand-orange rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-sm text-muted-foreground">
                    Practice physics problems related to electronics and computational physics.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-4 overflow-y-auto max-h-96">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    Computer Science USAT past papers to help you prepare effectively for the exam.
                  </p>
                </div>
              </div>
            </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <p className="text-sm text-muted-foreground">Rapidly evolving technology requires constant learning</p>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p className="text-sm text-muted-foreground">High competition in the tech industry</p>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p className="text-sm text-muted-foreground">Long hours of programming and debugging</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-brand-orange rounded-full mt-2 flex-shrink-0"></div>
                        <p className="text-sm text-muted-foreground">Leading tech universities with modern facilities</p>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-brand-orange rounded-full mt-2 flex-shrink-0"></div>
                        <p className="text-sm text-muted-foreground">Growing tech hub with startup opportunities</p>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-brand-orange rounded-full mt-2 flex-shrink-0"></div>
                        <p className="text-sm text-muted-foreground">High-demand skills with excellent job prospects</p>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-brand-orange rounded-full mt-2 flex-shrink-0"></div>
                        <p className="text-sm text-muted-foreground">Access to European tech market and companies</p>
                      </div>
                    </div>
                  </div>
                </div>
