...
const USATEngineering = () => {
  ...
  const preparationTips = [
    ...
    "Review FSc syllabus thoroughly",
    "Take mock tests to improve speed and accuracy"
  ];

  const pastPapersData = [
    { type: "USAT Engineering 2023", downloadUrl: "#" },
    { type: "USAT Engineering 2022", downloadUrl: "#" },
    { type: "USAT Engineering 2021", downloadUrl: "#" },
    { type: "Practice Test 1", downloadUrl: "#" },
    { type: "Practice Test 2", downloadUrl: "#" }
  ];

  const studyResourcesData = [
    { name: "USAT Engineering Prep Course", type: "YouTube", link: "#" },
    { name: "Engineering USAT Guide", type: "Website", link: "#" },
    { name: "Physics & Math Academy", type: "YouTube", link: "#" },
    { name: "Chemistry Study Portal", type: "Website", link: "#" }
  ];
...
<div className="space-y-6 px-4 py-6 sm:px-6">
  ...
  <div className="space-y-5">
    ...
    <div className="space-y-3">
      <div
        className="bg-brand-light-green rounded-xl px-4 py-3 flex justify-between items-center shadow-sm transition-colors duration-200 active:scale-[0.98]"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Card
                  className="cursor-pointer hover:shadow-lg smooth-transition"
                  onClick={() => setShowStudyResources(true)}
                >
                  <CardContent className="p-0">
                    <div className="relative w-full h-32 rounded-lg overflow-hidden">
              ...
              <div className="p-4 overflow-y-auto max-h-96">
                <div className="space-y-4">
                  {pastPapersData.map((paper, index) => (
                    <div key={index} className="flex justify-between items-center py-2 border-b border-brand-gray last:border-b-0">
